...
官方原文：https://www.keepalived.org/manpage.html
...
VRRP instance(s)
       ...
       vrrp_instance <STRING> {
           ...
           # created interface.
	   use_ipvlan [] [IP_ADDRESS] [bridge|private|vepa]
       ...
       virtual_server group <STRING> {
		   ...
		   connect_timeout <TIMER>         # see above
               ...
               HTTP_GET|SSL_GET {
                   ...
                   # each URL is checked, with a delay of  between
                   # each check. if there were 20 URLs, and the  were
